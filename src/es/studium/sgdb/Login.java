...
public class Login extends Connections implements WindowListener, ActionListener{
	...
	private boolean login() {
		...
		try {
            ...
            if(rs.next()) {
            	...
            	new Log(username, "LOG IN", "INICIO DE SESIÓN: " + "SELECT * FROM usuarios WHERE nombreUsuario = '"+username+"' AND contraseniaUsuario = SHA2('**********',256);");
            	return true;
            }
